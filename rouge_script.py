...
with open('ROUGE_SCORES_MODEL.csv', 'wb') as csvfile:
    writer = csv.writer(csvfile)
    writer.writerow(["rouge_l", "rouge_1", "rouge_2", "rouge_3", "bleu_score"])
    count = 0
    ...
    with open('last_results.txt', 'r') as f:
        while True:
            ...
            writer.writerow([rouge_l_score, rouge_1_score, rouge_2_score, rouge_3_score, bleu_score])
            count += 1
            if count % 1000 == 0:
                print count
